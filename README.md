...
Here is a working live demo : https://chautruong79.github.io/my-robofriends/
...
If you find a bug (the website couldn't handle the query and / or gave undesired results), kindly open an issue [here](https://github.com/chautruong79/my-robofriends/issues/new) by including your search query and the expected result.

If you'd like to request a new function, feel free to do so by opening an issue [here](https://github.com/chautruong79/my-robofriends/issues/new). Please include sample queries and their corresponding results.
